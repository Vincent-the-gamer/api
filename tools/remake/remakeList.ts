export const regions = [
    null, '法国', '中国', '德国', '加拿大', '日本', '英国', '美国', '韩国', '朝鲜', 
...
export function getSpecialIdentities(location: string) {
    ...
    if (specialLocations["交界地"].includes(location)) {
        ...
        return [
            "护士妹妹", "三角头", "阿蕾莎", "身寸男", "隐形怪", "双肛", "哈利·梅森(1代男主)", "詹姆斯·桑德兰(2代男主)",
            "希瑟·梅森(3代女主)", "亨利·汤森德(4代男主)", "沃特·苏利文(4代反派)", "阿历克斯·谢泼德(归乡男主)", "墨菲·潘德尔顿(暴雨男主)"
        ]
    } else if(specialLocations["浣熊市"].includes(location)) {
        return [
            "里昂·肯尼迪", "克里斯·雷德菲尔德", "克莱尔·雷德菲尔德", "艾达·王", "威廉·珀金", "亚妮·珀金", "雪莉·珀金",
            "马文·布拉纳", "吉尔·瓦伦丁", "卡洛斯·奥利维拉", "尼古拉·吉诺瓦耶夫", "阿尔伯特·威斯克", "小丧尸", "暴君", "猎杀者",
            "追踪者(Nemesis)"
        ]
    } else {
        switch (location) {
